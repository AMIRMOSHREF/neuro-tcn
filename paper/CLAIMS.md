...
| **P3** late-delay sufficiency | τ<sub>95</sub> ≤ 500 ms for the model (bootstrap CI upper bound) and for the linear all-unit sweep; occluding the last 400 ms costs more than any earlier 400 ms | context sweep, `csi`, `tau95_linear_ms`, `temporal_occlusion` | CI upper bound of τ<sub>95</sub>; paired Δ(last window) − max Δ(earlier windows) | upper CI > 500 ms, or linear τ<sub>95</sub> > 500 ms, or an earlier window costs as much |
